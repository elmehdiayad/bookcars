...
const strings = new LocalizedStrings({
  fr: {
    ...
    CUSTOMER_CARE_TITLE: 'Service client Volo',
    CONTACT_US: 'Nous Contacter',
    CUSTOMER_CARE_SUBTITLE: 'Toujours là pour vous aider',
    CUSTOMER_CARE_TEXT: 'Chez Volo, nous nous engageons à fournir une assistance rapide et fiable pour garantir que votre expérience de location de voiture soit fluide et agréable du début à la fin.',
  ...
  en: {
    ...
    CUSTOMER_CARE_TITLE: 'Volo Customer Care',
    CONTACT_US: 'Contact Us',
    CUSTOMER_CARE_SUBTITLE: 'Always Here to Help',
    CUSTOMER_CARE_TEXT: "At Volo, we're dedicated to providing prompt and reliable support to ensure your car rental experience is smooth and enjoyable from start to finish.",
  ...
  es: {
    ...
    CUSTOMER_CARE_TITLE: 'Atención al cliente de Volo',
    CONTACT_US: 'Contáctanos',
    CUSTOMER_CARE_SUBTITLE: 'Siempre aquí para ayudar',
    CUSTOMER_CARE_TEXT: 'En Volo, nos dedicamos a brindar asistencia rápida y confiable para garantizar que su experiencia de alquiler de automóviles sea fluida y placentera de principio a fin',
